...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $sql="select * from property inner join owns where property.propid=owns.propid and property.propid='$id'";
...
if(isset($_POST['updatep'])){
    ...
    // if($d_type=="Rent"){
    $sqld="DELETE FROM `propimages` WHERE propimages.propid='$id'";
    $resultp=mysqli_query($conn,$sqld);
    $sqlp = "UPDATE `property` SET `proptype`='$prop_type',`paddress`='$p_address',`price`='$p_price',`propdesc`='$prop_desc',`furnish`='$furnish',`floorspace`='$floor_space' WHERE property.propid='$id'";
    $result = mysqli_query($conn, $sqlp);
    if ($result) {
        $sql = "UPDATE `owns` SET `dtype`='$d_type' WHERE owns.propid='$id'";
        $result = mysqli_query($conn, $sql);
        if ($result) {
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    <h2 class="m-0">Update Property</h2>
                </div>
            </nav>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4 font-weight-bold">
                            ...
                            <input type="text" class="form-control" placeholder="" name="propid" value="<?php echo $fetch['propid'];?>" readonly>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-4 font-weight-bold">
                            <label for="inputAddress">Property Type</label>
                            <input type="text" class="form-control" placeholder="(Eg:1BHK,2BHK,1RK etc)" name="proptype" value="<?php echo $fetch['proptype'];?>" required>
                        </div>
                    </div>
                    <div class="form-row ">
                        <div class="form-group font-weight-bold col-md-3" id="floor">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" aria-label="Dollar amount (with dot and two decimal places)" name="floorspace" value="<?php echo $fetch['floorspace'];?>">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6 font-weight-bold">
                            ...
                            <input type="text" class="form-control" name="paddress" value="<?php echo $fetch['paddress'];?>" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-3 font-weight-bold">
                            <label for="inputCity">City</label>
                            <input type="text" class="form-control" name="pcity" value="<?php echo $fetch['pcity'];?>" readonly>
                        </div>
                        <div class="form-group col-md-3 font-weight-bold">
                            <label for="inputState">State</label>
                            <input type="text" class="form-control" name="pstate" value="<?php echo $fetch['pstate'];?>" readonly>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-3 font-weight-bold">
                            <label for="inputZip">Country</label>
                            <input type="text" class="form-control" name="pcountry" value="<?php echo $fetch['pcountry'];?>" readonly>
                        </div>
                        <div class="form-group col-md-3 font-weight-bold">
                            <label for="inputZip">Pin Code</label>
                            <input type="text" class="form-control" name="ppincode" value="<?php echo $fetch['ppin'];?>" readonly>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-3 font-weight-bold">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" aria-label="Dollar amount (with dot and two decimal places)" name="pprice" value="<?php echo $fetch['price'];?>">
                            </div>
                        </div>
                    ...
                    <button type="submit" class="btn btn-secondary bg-dark" name="updatep">Update</button>
                </form>
